                            ...
                            <div class="dt-module__container">
                                ...
                                <div class="dt-module__header z0 d-none d-md-flex">
                                    <div class="row w-100">
                                        ...
                                        <div class="col-md-4">
                                        <button type="button" class="btn btn-info method-button text-capitalize ml-3" style="border-radius: 3px;float: right;" data-toggle="modal" data-target="#form-modaldeleteLang"><?php echo lang("delete") ?></button>
                                        <button type="button" class="btn btn-info method-button text-capitalize" style="border-radius: 3px;float: right;" data-toggle="modal" data-target="#form-modaleditLang"><?php echo lang("edit") ?></button>
                                        </div>
                                    </div>
                                <!-- /search box -->
                                </div>
                                ...
                                <!-- /modal -->
                                <!-- Modal -->
                                <div class="modal fade display-n" id="form-modaldeleteLang" tabindex="-1" role="dialog"
                                    aria-labelledby="model-8" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                                <h3 class="modal-title text-capitalize" id="model-8"><?= lang("delete") ?></h3>
                                                <button type="button" class="close"
                                                    data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            ...
                                            <!-- /modal header -->
                                            <?php echo form_open( base_url( 'settings/deleteLanguage' ) , array( 'class' => 'lang','id' => 'deleteLang', 'enctype=' => 'multipart/form-data' ));?>
                                            <!-- Modal Body -->
                                            <div class="modal-body">
                                                <input type="text" name="lid" class="form-control " id="llid" value="<?php echo $langID ?>" hidden>
                                                <h4>Please confirm that you want to delete this language. Once deleted, you will not be able to recover translated strings.</h4>
                                            </div>
                                            <!-- /modal body -->
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit"
                                                    class="btn btn-primary btn-sm text-capitalize"><?php echo lang("delete") ?>
                                                </button>
                                            </div>
                                            <!-- /modal footer -->
                                            <?php echo form_close();?>
