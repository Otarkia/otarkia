                    ...
                    <div class="classy-menu menu-on">
                        ...
                        <div class="classynav classynav-pt2">
                            <ul id="nav" class="mr-4">
                                ...
                                <li class="f-500"><a href="#about">About Us</a></li>
                                <li class="f-500"><a href="#plans">Plans</a></li>
                            ...
                            -->
                            <!-- Button -->
                            <a href="<?=base_url('login') ?>" class="btn btn-info-pt2 text-uppercase mr-3">
                                <?= lang("login") ?>
                            </a>
                            <a href="<?=base_url() ?>"
                                class="btn btn-primary-pt2 text-uppercase">Sign up</a>
                            <div class="lang-select text-uppercase">
                                <a href="#" id="currentLang" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="<?php echo base_url('uploads/'.$this->site_lang->logo) ?>">
                                    <?php echo $this->site_lang->code ?>
                                </a>
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(8px, 72px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    <?php foreach($this->site_languages as $language) {?>
                                    <button class="dropdown-item sitelangChange" type="button" data-id="<?php echo base_url('switchlang/').$language->name ?>">
